...
#             self.model.save("ppo_ball_game2")
...
# # 使用 MlpPolicy
# model = PPO(policy='MlpPolicy', env=env, verbose=1, tensorboard_log=log_path, learning_rate=5e-4, n_steps=2048, batch_size=64, gamma=0.99, gae_lambda=0.95, clip_range=0.2, ent_coef=0.1)
# # model.load("ppo_ball_game")
# model.learn(total_timesteps=2000000, callback=logger_callback,progress_bar=True)
# # 保存和加载模型
# model.save("ppo_ball_game2")
